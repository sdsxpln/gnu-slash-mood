...
int is_male_name(char * ch)
{
    ...
    while (male_name[i] != NULL) {
        if (strcmp(male_name[i], ch) == 0) return 1;
        i++;
    }
    return 0;
}
...
int is_female_name(char * ch)
{
    ...
    while (female_name[i] != NULL) {
        if (strcmp(female_name[i], ch) == 0) return 1;
        i++;
    }
    return 0;
}
...
{
    if (is_female_name(ch)!=0) {
        return GENDER_FEMININE;
    }
    else {
        if (is_male_name(ch)!=0) {
